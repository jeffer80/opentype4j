...
public class SVGUtils {
	...
	public static void writeToSVG(File file, String svgDomString) throws IOException {
	...
	public static void converSVGToImage(InputStream in, OutputStream out, ImageFormat format) {
		try {
			...
			if (format == ImageFormat.JPEG) {
				...
				transcoder.addTranscodingHint(JPEGTranscoder.KEY_QUALITY, Float.valueOf(0.8f));
			} else {
